...
sys.modules["vllm.logger"].init_logger = lambda x: MagicMock()  # type: ignore[attr-defined]
...
protocol_mock.DeltaFunctionCall = DeltaFunctionCall  # type: ignore[attr-defined]
protocol_mock.DeltaToolCall = DeltaToolCall  # type: ignore[attr-defined]
protocol_mock.DeltaMessage = DeltaMessage  # type: ignore[attr-defined]
protocol_mock.FunctionCall = FunctionCall  # type: ignore[attr-defined]
protocol_mock.ToolCall = ToolCall  # type: ignore[attr-defined]
protocol_mock.ExtractedToolCallInformation = ExtractedToolCallInformation  # type: ignore[attr-defined]
...
def test_extract_tool_calls_no_tools():
    ...
    print("✓ test_extract_tool_calls_no_tools")
...
def test_extract_tool_calls_single():
    ...
    print("✓ test_extract_tool_calls_single")
...
def test_extract_tool_calls_multiple():
    ...
    print("✓ test_extract_tool_calls_multiple")
...
def test_streaming_no_tool_calls():
    ...
    print("✓ test_streaming_no_tool_calls")
...
def test_streaming_tool_call_not_leaked():
    ...
    print("✓ test_streaming_tool_call_not_leaked")
...
def test_streaming_reentry_after_section():
    ...
    print("✓ test_streaming_reentry_after_section")
...
def test_streaming_same_chunk_begin_end():
    ...
    # Content before the section should have been emitted, markers should not leak.
    assert result is not None
    assert result.content == "Reasoning "
    print("✓ test_streaming_same_chunk_begin_end")
...
def test_state_reset():
    ...
    parser.streamed_args_for_tool = ["old_args"]
...
def test_suppress_noise_between_markers():
    ...
    print("✓ test_suppress_noise_between_markers")
...
def test_the_failing_scenario():
    ...
    deltas = [
        ...
        ("<|tool_call_end|>", [105]),
        (
            "<|tool_call_begin|>functions.file_read:6"
            "<|tool_call_argument_begin|>"
            '{"path": "/test2.md"}',
            [104, 3, 106, 4],
        ),
    ...
    print("✓ test_the_failing_scenario")
